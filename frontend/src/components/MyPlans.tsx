  ...
  const handleCreate = async () => {
    ...
    */
    ...
    await createPlan({
      ...
      items,
      weeks: [
        { id: 'w1', weekLabel: `Tuần 1`, plannedHours: weeks[0], startLesson: 1, endLesson: 3, date: '' },
        { id: 'w2', weekLabel: `Tuần 2`, plannedHours: weeks[1], startLesson: 1, endLesson: 3, date: '' },
        { id: 'w3', weekLabel: `Tuần 3`, plannedHours: weeks[2], startLesson: 1, endLesson: 3, date: '' },
        { id: 'w4', weekLabel: `Tuần 4`, plannedHours: weeks[3], startLesson: 1, endLesson: 3, date: '' },
        { id: 'w5', weekLabel: `Tuần 5`, plannedHours: weeks[4], startLesson: 1, endLesson: 3, date: '' },
      ],
    });
